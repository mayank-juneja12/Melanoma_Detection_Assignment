...
## Conclusions
The Data Augmentation techniques can help in increasing the accuracy.
Class imbalance problem can be rectified using Augmentor
By using Dropout the overfitting can be greatly reduced 
